...
void warning(const char* fmt, ...) {
  va_list arg;
  va_start(arg, fmt);
  esphome::esp_log_vprintf_(3, "wmbusmeters", 1, fmt, arg);
  va_end(arg);
}
...
void error(const char* fmt, ...) {
  va_list arg;
  va_start(arg, fmt);
  esphome::esp_log_vprintf_(3, "wmbusmeters", 2, fmt, arg);
  va_end(arg);
}
...
void debug(const char* fmt, ...) {
  va_list arg;
  va_start(arg, fmt);
  esphome::esp_log_vprintf_(3, "wmbusmeters", 3, fmt, arg);
  va_end(arg);
}
...
void verbose(const char* fmt, ...) {
  va_list arg;
  va_start(arg, fmt);
  esphome::esp_log_vprintf_(3, "wmbusmeters", 4, fmt, arg);
  va_end(arg);
}
...
bool doesIdMatchExpressions(const std::string& id, std::vector<std::string>& mes, bool* used_wildcard)
{
...
bool doesIdsMatchExpressions(std::vector<std::string>& ids, std::vector<std::string>& mes, bool* used_wildcard)
{
    bool match = false;
